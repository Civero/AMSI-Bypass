...
function Memory_patch

#Detectado por ESET pero no por Windows Defender

{

    Write-Host "";
    Write-Host "Técnica original de Paul Laîné (@am0nsec)";
    Write-Host "https://www.contextis.com/us/blog/amsi-bypass";
    Write-Host "";
    Write-Host -ForegroundColor Yellow "Parcheando memoria...";
